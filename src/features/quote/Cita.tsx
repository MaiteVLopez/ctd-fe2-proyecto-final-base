...
function Cita() {
  ...
  return (
    <ContenedorCita>
      <TextoCita placeholder="Cita" data-testid="Cita">{obtenerMensaje(cita, estadoPedido)}</TextoCita>
      <AutorCita placeholder="Personaje" data-testid="Pesonaje">{personaje}</AutorCita>
      <Input
